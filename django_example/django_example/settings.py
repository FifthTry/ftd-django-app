...
SECRET_KEY = "DONT WORRY ABOUT THIS KEY"
...
TEMPLATES = [
    ...
    },
    {
        ...
        "DIRS": ["ui"],
        "OPTIONS": {
            "PROCESSORS": ["app.processors.todo_title", "app.processors.todo_data", "app.processors.test_data", "app.processors.get_helper_data"]
        }
    },
]
